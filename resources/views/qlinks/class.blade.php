...
<head>
    ...
    <title>Classes - KijotableFit</title>
...
<body>
    <header>
        <h1 class="text-center my-4">Our Classes</h1>
    </header>

    <main class="container">
        <p>At KijotableFit, we offer a wide range of classes designed to meet your fitness goals.
            From strength training to yoga, we have something for everyone.</p>
        <div class="mt-4">
