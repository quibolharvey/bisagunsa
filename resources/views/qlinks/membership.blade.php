...
<head>
    ...
    <title>Membership - KijotableFit</title>
...
<body>
    <header>
        <h1 class="text-center my-4">Membership Plans</h1>
    </header>

    <main class="container">
        <p>We offer flexible membership plans to fit your lifestyle. Whether you're looking for a monthly or yearly commitment, we have the perfect plan for you.</p>
